				...
				function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
					...
					$.ajaxFileUpload({
						...
						success: function(obj) //服务器成功响应处理函数
						{
							...
							var imgObj = $("<img>");
							//给img标签对象追加属性
							imgObj.attr("src","/01_war_exploded/image_big/"+obj.imgurl);
...
<script type="text/javascript">
	function myclose(ispage) {
		...
		//window.close();
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update2.action"
...
<%--					<input type="hidden" value="${prod.pdate}" 							name="pdate">--%>
					...
					<table>
						...
						<tr>
							...
							<td><input type="text"
									   													name="pcontent"
									   class="two" value="${prod.pcontent}"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
						...
						<tr>
							...
							<td><input type="number"
									   													name="pprice"
									   class="two" value="${prod.pprice}"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;">
								<img src="/01_war_exploded/image_big/${prod.pimage}" width="100px" height="100px" >
							</div><br><br><br><br>
